...
var SekindoClientDetections_URL = function (config) {
	...
	if (this.isPlayerApiActions && !this.isAmpProject && !this.isAmpIframe && !this.isApp) this.playerApiActions();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=107415&cbuster=[CACHE_BUSTER]&pubUrl=[PAGE_URL_ENCODED]&subId=Home&cbuster=1657573195',
					origQString: 's=107415&cbuster=[CACHE_BUSTER]&pubUrl=[PAGE_URL_ENCODED]&subId=Home',
					placementId: 107415,
					x: 728,
					y: 352,
					videoType: 'flow',
					...
					isAPI: false,
					debug: 0,
					ci: {"extra":{"schemaVer":"11","os":"Windows","osVersion":"10.0","osVersionMajor":"10","osVersionMinor":"0","deviceManufacturer":"","deviceModel":"","deviceCodeName":"","deviceType":"desktop","browser":"Chrome","browserType":"browser","browserVersion":"103.0.5060.114","browserVersionMajor":"103","browserVersionMinor":"0","chromeVersion":"103"},"browser":"chrome","os":"windows","osVer":"","deviceType":"desktop","languages":["en"],"googlePSI":false},
					isFpCookie: 0,
					geo: 'US',
					dmaCode: 753,
					dynamicSetup: [],
